...
from losses import dice_loss, dice_loss_total_variation
...
def get_gpunet_bn(loss):
    ...
    ######################
    conv4 = Conv2D(nfeat*2, (3, 3), activation = 'relu', kernel_initializer='normal', padding='same')(conv3)
    conv4 = Conv2D(nfeat*2, (3, 3), activation = 'relu', kernel_initializer='normal', padding='same')(conv4)
