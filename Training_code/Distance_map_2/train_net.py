...
def trainModel():
    ...
    train_set_x = loadDistanceMap('../../training_files_fixes.csv' , "../../../DATA/data/training_distance_map_2/from_network_1/")
    train_set_x_label = loadDistanceMap('../../training_files_fixes.csv' , '../../../DATA/labels/training_distance_map_2/distance_map_white_1_512_128/' )
    valid_set_x = loadDistanceMap('../../validation_files_fixes.csv' , "../../../DATA/data/training_distance_map_2/from_network_1/")
    valid_set_x_label = loadDistanceMap('../../validation_files_fixes.csv' , '../../../DATA/labels/training_distance_map_2/distance_map_white_1_512_128/' )
    ...
    train_set_x_label = np.reshape(train_set_x_label, (len(train_set_x_label),len(train_set_x_label[0]),len(train_set_x_label[0][0]),1))
    valid_set_x_label = np.reshape(valid_set_x_label, (len(valid_set_x_label),len(valid_set_x_label[0]),len(valid_set_x_label[0][0]),1))
...
if __name__ == '__main__':
    ...
    loss = 'dice_loss' # mean_squared_error , dice_loss
    ...
    result_path = '../../../Results/Distance_map_2_prediction/'
    ...
    datagen_params["augmentation"]['random_transform']['holes']=True
    datagen_params["augmentation"]['save_folder']= ''+ result_path +'/' + exp_name +'/Augmented_images/'


    # path_training_images = '../../../DATA/data/training_distance_map/reduced_images'
    path_training_images = '../../../DATA/data/training_distance_map_2/'
